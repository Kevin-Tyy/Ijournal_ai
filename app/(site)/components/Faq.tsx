  ...
  return (
    <div className="space-y-6">
      {faqList.map((faq, index) => (
        <Motion transition={{ duration: 0.4, delay : 0.1 * index }} variants={{ hidden: { opacity: 0, y: 80 }, visible: { opacity: 1, y: 0 } }}>
          <div key={index} className={`rounded-[24px] sm:rounded-[30px] transition-all duration-500 ${isOpen && currentItem === index && "bg-[#F6F6F6]"}`}>
            <div
              ...
              <div
                className={`p-3 sm:p-4 rounded-full bg-[#F6F6F6] transition-all duration-500 ${
                  isOpen && currentItem === index && "bg-primary-blue text-white"
                }`}>
                {isOpen && currentItem === index ? (
                  <Minus size={28} className="w-[20px] h-[20px] sm:w-[28px] sm:h-[28px]" />
                ) : (
                  <Plus size={28} className="w-[20px] h-[20px] sm:w-[28px] sm:h-[28px]" />
                )}
              </div>
            </div>
    ...
    component: (
      <div className="space-y-5">
        <p className="leading-relaxed">
          Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum been the industry's standard dummy text ever since the{" "}
        </p>
