        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
            {features.map((feature, index) => (
              <Motion key={index} transition={{ duration: 0.2 * index }} variants={{ hidden: { opacity: 0, y: -30 }, visible: { opacity: 1, y: 0 } }}>
        ...
        <div className="max-w-[1360px] mx-auto flex flex-col items-center space-y-10">
          ...
          <div className="space-y-4 sm:space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-y-4 sm:gap-8">
              <div className="bg-[#F8F8F8] px-5 sm:px-10 md:px-20 py-5 sm:py-6 md:py-12 flex flex-col md:flex-row items-center gap-10 md:gap-20 col-span-2 rounded-[40px]">
              ...
              <div className="bg-[#F8F8F8] p-5 sm:p-8 rounded-[30px] sm:rounded-[40px] space-y-4 sm:space-y-7 col-span-1 block md:hidden lg:block">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
              <div className="bg-[#F8F8F8] p-5 sm:p-8 rounded-[30px] sm:rounded-[40px] space-y-4 sm:space-y-7 col-span-1 hidden md:block lg:hidden">
                <Image src="/assets/fast-billing.svg" alt="" width={1000} height={300} />
                <div className="w-full space-y-4">
                  <h1 className="text-2xl font-semibold">Fast Billing</h1>
                  <p className="text-[#54607A] leading-relaxed max-w-[320px]">
              ...
              <div className="bg-[#F8F8F8] p-5 sm:p-8 rounded-[30px] sm:rounded-[40px] space-y-4 sm:space-y-7">
