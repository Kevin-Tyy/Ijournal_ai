  ...
  return (
    <footer className="px-4 -mt-28 sm:-mt-16">
      <div className="bg-gradient-to-r from-[#adf5ff] to-[#ffcedf] max-w-[1360px] mx-auto p-6 sm:p-8 md:p-16 flex flex-col lg:flex-row rounded-[32px] sm:rounded-[40px] translate-y-28 space-y-4">
        <h1 className="text-2xl sm:text-3xl md:text-4xl w-full font-bold leading-relaxed sm:leading-loose">Take control of your personal Journals today</h1>
            ...
            <div className="w-full flex flex-wrap gap-x-10 gap-y-12 justify-between">
              ...
              <div className="space-y-8">
                ...
                <ul className="space-y-5">
                  ...
                  <button className="rounded-full bg-gradient-to-br from-[#7769D4] to-[#9586FB] text-white py-4 px-6 uppercase text-sm">
                    Chat with Us
                  </button>{" "}
                </ul>
              </div>
